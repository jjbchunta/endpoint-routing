 ...
 */
async function simulatePathRequest_iter_2(path, method, req, res, next = null) {
 ...
 * @returns {Promise<any>} The result of the callback execution, or an error object if not found.
 */
async function simulatePathRequest_iter_1(path, method, req, res, next = null) {
    method = formatHTTPMethod(method);
    ...
    callback = retrieveCallbackFromModule(module, method);
